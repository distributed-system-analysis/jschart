...
function build_chart(chart) {
	...
	for (var i=0; i<chart.options.csvfiles.length; i++) {
	    ...
	    chart.datasets_queue.defer(load_csv_text, chart.options.csvfiles[i], chart);
	}
    } else {
...
exports.create_jschart = function(stacked, data_model, location, chart_title, x_axis_title, y_axis_title, options) {
